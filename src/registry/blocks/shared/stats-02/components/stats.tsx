    ...
    <div className="py-20">
      <div className="mx-auto w-full max-w-(--breakpoint-xl) px-6 py-12 xl:px-0">
        ...
        <div className="mt-16 grid justify-center gap-x-10 gap-y-16 sm:mt-24 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div>
            <span className="font-heading font-medium text-5xl tracking-[-0.015em] md:text-6xl">
              900+
            </span>
          ...
          <div>
            <span className="font-heading font-medium text-5xl text-muted-foreground tracking-[-0.015em] md:text-6xl">
              10,000+
            </span>
