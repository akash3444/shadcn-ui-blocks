    ...
    <div className="mx-auto max-w-5xl px-6 py-20">
      ...
      <div className="mt-14 grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        <div className="rounded-xl border bg-muted p-6 py-7">
          ...
          <span className="font-heading font-medium text-5xl tracking-[-0.01em]">70%</span>
        ...
        <div className="rounded-xl border bg-muted p-6 py-7">
          ...
          <span className="font-heading font-medium text-5xl tracking-[-0.01em]">5x</span>
          <p className="mt-4 text-foreground/80 text-xl">
        ...
        <div className="rounded-xl border bg-muted p-6 py-7">
          ...
          <span className="font-heading font-medium text-5xl tracking-[-0.01em]">98%</span>
          <p className="mt-4 text-foreground/80 text-xl">
