  ...
  return (
    <div className="w-full px-6">
      <div className="relative mx-auto my-20 max-w-5xl overflow-hidden rounded-2xl bg-muted px-6 py-16">
        <h2 className="text-balance text-center font-heading font-medium text-3xl tracking-[-0.02em] sm:text-4xl md:text-[2.75rem]">
          Reliable by Design
        </h2>
        ...
        <div className="mt-20 grid grid-cols-1 gap-4 gap-y-16 text-center sm:grid-cols-2 md:grid-cols-3">
          <div>
            <span className="font-heading font-medium text-5xl text-foreground">70%</span>
            <p className="mt-4 text-foreground/80 text-xl">
              Faster UI development
            </p>
          </div>
          <div>
            <span className="font-heading font-medium text-5xl text-foreground">5x</span>
            <p className="mt-4 text-foreground/80 text-xl">
