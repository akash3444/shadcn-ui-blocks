  ...
  return (
    <div className="min-h-dvh bg-muted/50 px-6 py-10">
      <div className="mx-auto w-full max-w-2xl">
        <div className="relative overflow-hidden rounded-xl border border-border/55 bg-background p-8 shadow-[0_0_10px_rgba(0,0,0,0.04)] dark:border-border/75 dark:shadow-[0_0_20px_rgba(0,0,0,0.4)]">
          <div
    ...
    repeating-linear-gradient(
      ...
      `,
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 *:h-72 sm:grid-cols-2">
          {projects.map((project) => (
            <div
              className="relative flex flex-col overflow-hidden rounded-xl border border-border/60 bg-background p-1 shadow-[0_0_15px_rgba(0,0,0,0.05)] dark:border-border/85 dark:shadow-[0_0_20px_rgba(0,0,0,0.4)]"
              key={project.name}
            >
              <div className="mask-b-from-50% dark:mask-b-from-10% dark:mask-b-to-70% size-full rounded-lg">
                <img
                  alt={project.name}
...
const projects = [
  {
    ...
    description: "A collection of shadcn/ui blocks.",
    image: "https://fffuel.co/images/dddepth-preview/dddepth-028.jpg",
  },
  {
    name: "Databuddy",
    description: "Privacy-first web analytics.",
    image: "https://fffuel.co/images/dddepth-preview/dddepth-051.jpg",
  },
  {
    name: "dddepth",
    description: "A collection of AI-generated abstract 3D shapes.",
    image: "https://fffuel.co/images/dddepth-preview/dddepth-248.jpg",
  },
  {
    name: "Pattern Craft",
    description: "Modern background patterns and gradient snippets.",
    image: "https://fffuel.co/images/dddepth-preview/dddepth-045.jpg",
  },
];
