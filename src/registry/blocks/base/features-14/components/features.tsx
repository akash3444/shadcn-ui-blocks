...
export default function Features() {
  return (
    ...
    >
      ...
      <h2 className="mx-auto mt-5 max-w-4xl text-balance font-heading font-medium text-4xl/tight tracking-[-0.02em] sm:text-[2.75rem]">
        ...
        {plusPoints.map((plusPoint) => (
          ...
          >
            ...
            <div className="isolate flex flex-col items-center gap-2">
              ...
              <h3 className="mt-8 font-heading font-medium text-xl tracking-[-0.005em]">
                {plusPoint.title}
              </h3>
