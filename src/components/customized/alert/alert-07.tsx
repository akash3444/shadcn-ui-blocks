...
export default function AlertCalloutDemo() {
  return (
    <div className="w-full space-y-4">
      ...
      <Alert className="bg-blue-500/10 dark:bg-blue-600/30 text-blue-500 border-none">
        <CircleFadingArrowUpIcon className="h-4 w-4" />
        <AlertTitle>A new version of the app is now available.</AlertTitle>
      </Alert>
      <Alert className="bg-amber-500/10 dark:bg-amber-600/30 text-amber-500 border-none">
        <ShieldAlert className="h-4 w-4" />
        <AlertTitle>Changes will overwrite existing data.</AlertTitle>
      </Alert>
      <Alert className="bg-destructive/10 dark:bg-destructive/20 text-destructive border-none">
